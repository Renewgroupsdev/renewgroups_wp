...
function renew_homepage_defaults() {
    ...
    $defaults = array(
        ...
        'team1_bio' => 'Sets the long-term vision and steers strategic direction across the group\'s healthcare, technology and education ventures.',
        'team2_image' => '',
        'team2_name' => 'Ms. Divya Rajendran',
        'team2_role' => 'Chief Financial Officer & Co-Founder',
        'team2_bio' => 'Keeps the group\'s finances disciplined and governance transparent, having co-built the operating structure all four companies run on.',
        'team3_image' => '',
        'team3_name' => 'To be announced',
        'team3_role' => 'Chief Operating Officer',
        'team3_bio' => 'The operational backbone of the group, turning strategy into execution and keeping Renew Plus, Zelora Infotech, Rivan Institute and The New Mars Properties running in sync.',
        'team4_image' => '',
        'team4_name' => 'To be announced',
        'team4_role' => 'General Manager',
        'team4_bio' => 'Owns the day-to-day details that keep the business moving — cross-team coordination, on-time delivery and consistent execution across every vertical.',
        'team5_image' => '',
        'team5_name' => 'To be announced',
        'team5_role' => 'Chief Growth Officer',
        'team5_bio' => 'Hunts for the group\'s next stage of growth, forging partnerships and opening new markets across healthcare, technology, education and real estate.',
...
function renew_homepage_customizer($wp_customize) {
    ...
    $fields = array(
        ...
        'team' => array(
            ...
            array('team1_bio', 'Leader 1 bio', "Sets the long-term vision and steers strategic direction across the group's healthcare, technology and education ventures.", 'textarea'),
            ...
            array('team2_bio', 'Leader 2 bio', "Keeps the group's finances disciplined and governance transparent, having co-built the operating structure all four companies run on.", 'textarea'),
            ...
            array('team3_bio', 'Leader 3 bio', "The operational backbone of the group, turning strategy into execution and keeping Renew Plus, Zelora Infotech, Rivan Institute and The New Mars Properties running in sync.", 'textarea'),
            ...
            array('team4_bio', 'Leader 4 bio', "Owns the day-to-day details that keep the business moving — cross-team coordination, on-time delivery and consistent execution across every vertical.", 'textarea'),
            ...
            array('team5_bio', 'Leader 5 bio', "Hunts for the group's next stage of growth, forging partnerships and opening new markets across healthcare, technology, education and real estate.", 'textarea'),
        ),
        'partner' => array(
